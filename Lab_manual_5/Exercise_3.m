...
eqn1 = diff(e1, t) == 1; % e1(t) is the unit step function
eqn2 = diff(i1, t) == (e1 - e2)/1; % Ohm's law for the 1 Ohm resistor
eqn3 = diff(e2, t) == i2; % definition of capacitor voltage
eqn4 = diff(i2, t) == (e2 - i1)/0.5; % definition of inductor current
